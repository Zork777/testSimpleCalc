 ...
 * Usage:
 * <pre>  {@literal @}Rule
 * public Utils.ScreenShooter makeScreenshotOnFailure = Utils.ScreenShooter.failedTests();</pre>
 * or
 * <pre>  {@literal @}Rule
 * public Utils.ScreenShooter makeScreenshotOnEveryTest = Utils.ScreenShooter.failedTests().succeededTests();</pre>
 * or
 * <pre>  {@literal @}Rule
 * public Utils.ScreenShooter makeScreenshotOnEveryTest = Utils.ScreenShooter.failedTests().to("test-results/img/");</pre>
 *
 * <p>
 *   Restrictions:
 * </p>
